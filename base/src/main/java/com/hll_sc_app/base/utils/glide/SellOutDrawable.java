...
public class SellOutDrawable extends Drawable {
    private static final String SELL_OUT_TEXT = "商品售罄";
    ...
    public SellOutDrawable(Bitmap source) {
        this.mSource = source;
        ...
        float textWidth = mPaint.measureText(SELL_OUT_TEXT);
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawText(SELL_OUT_TEXT
            , (float) mSourceWidth / 2
            , (float) mSourceHeight / 2 + (-mPaint.ascent() - mPaint.descent()) / 2
            , mPaint);
    }
