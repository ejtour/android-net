...
/**
 * Created by zhuyingsong on 2019/2/14.
 */
public class CustomWeekBarView extends WeekBar {
    ...
    public CustomWeekBarView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.base_custom_week_bar, this, true);
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(R.array.base_chinese_week_string_array);
