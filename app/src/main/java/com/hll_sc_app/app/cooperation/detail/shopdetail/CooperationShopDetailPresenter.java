 ...
 * @date 2019/7/19
 */
public class CooperationShopDetailPresenter implements CooperationShopDetailContract.ICooperationShopDeliveryPresenter {
    private CooperationShopDetailContract.ICooperationShopDeliveryView mView;
    ...
    @Override
    public void register(CooperationShopDetailContract.ICooperationShopDeliveryView view) {
