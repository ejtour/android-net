 ...
 * @date 2019/7/17
 */
public class CooperationAddShopPresenter implements CooperationAddShopContract.ICooperationAddShopPresenter {
    private CooperationAddShopContract.ICooperationAddShopView mView;
    private int mPageNum;
    private int mTempPageNum;

    static CooperationAddShopPresenter newInstance() {
        return new CooperationAddShopPresenter();
    }
    ...
    @Override
    public void register(CooperationAddShopContract.ICooperationAddShopView view) {
        ...
        AgreementPriceService.INSTANCE.queryCooperationPurchaserShopList(req)
            ...
            .subscribe(new BaseCallback<List<PurchaserShopBean>>() {
                ...
                public void onSuccess(List<PurchaserShopBean> result) {
                    ...
                    mView.showPurchaserShopList(result, mPageNum != 1);
                }
