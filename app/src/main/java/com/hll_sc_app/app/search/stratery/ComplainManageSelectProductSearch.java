...
public class ComplainManageSelectProductSearch implements ISearchContract.ISearchStrategy {

    @Override
    public void onSearch(String searchWords) {
        ComplainManageEvent event = new ComplainManageEvent(ComplainManageEvent.TARGET.SELECT_PRODUCT_LIST, REFRESH);
