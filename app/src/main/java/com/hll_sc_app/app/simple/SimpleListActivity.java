...
@Route(path = RouterConfig.SIMPLE_LIST)
public class SimpleListActivity extends BaseActivity {
    ...
    public static void start(String title, ArrayList<String> list) {
        ARouter.getInstance()
                .build(RouterConfig.SIMPLE_LIST)
    ...
    private void initView() {
        ...
        mListView.setAdapter(new SimpleStringAdapter(mList));
    }
