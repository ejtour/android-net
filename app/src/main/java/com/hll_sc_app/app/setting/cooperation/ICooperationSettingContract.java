 ...
 * 
 */
public interface ICooperationSettingContract {
    ...
    interface ICooperationSettingPresenter extends IPresenter<ICooperationSettingContract.ICooperationSettingView> {
