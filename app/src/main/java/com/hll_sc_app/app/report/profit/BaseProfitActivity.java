...
public abstract class BaseProfitActivity extends BaseLoadActivity implements IProfitContract.IProfitView {
    ...
    private IProfitContract.IProfitPresenter mPresenter;
    ...
    private void initData() {
        mReq.put("type", String.valueOf(getType()));
        ...
        updateSelectedDate();
        mPresenter = ProfitPresenter.newInstance();
    ...
    private void initView() {
        ...
        mSearchView.setContentClickListener(new SearchView.ContentClickListener() {
            ...
            public void click(String searchContent) {
                RefundSearchActivity.start(BaseProfitActivity.this);
            }
