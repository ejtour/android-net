...
public class ReportEntryActivity extends BaseLoadActivity {
    ...
    private List<ReportItem> prepareMenu() {
        ...
        list.add(new ReportItem(ReportIcon.SALES_MAN_SIGN, ReportLabel.SALES_MAN_SIGN_ACHIEVEMENT, RouterConfig.REPORT_SALESMAN_SIGN_ACHIEVEMENT));
        list.add(new ReportItem(ReportIcon.SALES_PERFORMANCE, ReportLabel.SALES_MAN_SALES_ACHIEVEMENT, RouterConfig.REPORT_SALESMAN_SALES_ACHIEVEMENT));
        list.add(new ReportItem(ReportIcon.STOCKOUT_DIFFERENCES, ReportLabel.DELIVERY_LACK_GATHER, RouterConfig.REPORT_DELIVERY_LACK_GATHER));
