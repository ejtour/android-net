...
@Route(path = RouterConfig.REPORT_LACK_DETAILS)
public class LackDetailsActivity extends BaseLoadActivity implements ILackDetailsContract.ILackDetailsView {
    ...
    private ILackDetailsContract.ILackDetailsPresenter mPresenter;
    ...
    private void initData() {
        ...
        mPresenter = LackDetailsPresenter.newInstance();
    ...
    private void initView() {
        ...
        mSearchView.setContentClickListener(new SearchView.ContentClickListener() {
            ...
            public void click(String searchContent) {
                SearchActivity.start(LackDetailsActivity.this, searchContent, CommonSearch.class.getSimpleName());
            }
    ...
    private View generateHeader() {
        ...
        row.updateRowDate("商品名称", "规格/单位", "订货量", "订货金额(元)", "发货量", "缺货量", "缺货金额(元)", "缺货率");
