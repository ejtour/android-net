...
public class WareHouseDeliveryActivity extends BaseLoadActivity implements IWareHouseDeliveryContract.IWareHouseDeliveryView {
    ...
    ExcelLayout mExcel;
    private IWareHouseDeliveryContract.IWareHouseDeliveryPresenter mPresenter;
    ...
    private void initData() {
        ...
        updateSelectedDate();
        mPresenter = WareHouseDeliveryPresenter.newInstance();
    ...
    private void initView() {
        mTitleBar.setHeaderTitle("代仓发货统计");
    ...
    @Override
    public void setData(List<WareHouseDeliveryBean> list, boolean append) {
        if (!append) {
            mIndex.set(0);
        }
        if (!CommonUtils.isEmpty(list))
            for (WareHouseDeliveryBean bean : list) {
    ...
    public void showPurchaserWindow(View view) {
        ...
        if (mPurchaserWindow == null) {
            ...
            mPurchaserWindow.setListener(bean -> {
                ...
                mReq.put("shipperGroupID", bean.getPurchaserID());
                mPresenter.loadList();
            });
