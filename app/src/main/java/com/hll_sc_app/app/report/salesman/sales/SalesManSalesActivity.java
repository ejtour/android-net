 ...
 * @since 2019/12/12
 */
@Route(path = RouterConfig.REPORT_SALESMAN_SALES)
public class SalesManSalesActivity extends BaseLoadActivity implements DateFilterView.DateFilterCallback, ISalesManSalesContract.ISalesManSalesView {
    private static final int[] WIDTH_ARRAY = {120, 80, 80, 80, 80, 80, 80};
    ...
    private ISalesManSalesContract.ISalesManSalesPresenter mPresenter;
    ...
    private void initView() {
        ...
        mSearchView.setContentClickListener(new SearchView.ContentClickListener() {
            ...
            public void click(String searchContent) {
                SearchActivity.start(SalesManSalesActivity.this, searchContent, SimpleSearch.class.getSimpleName());
            }
    ...
    private void initData() {
        ...
        mPresenter = SalesManSalesPresenter.newInstance();
    ...
    private View generateHeader() {
        ...
        row.updateRowDate("编码", "姓名", "有效订单数", "销售金额(元)", "结算订单数", "结算金额(元)", "退款金额(元)");
    ...
    @Override
    public void setData(SalesManSalesResp resp, boolean append) {
        CharSequence[] array = {};
        mFooter.updateRowDate(resp.convertToRowData().toArray(array));
        List<SalesManSalesAchievement> records = resp.getRecords();
