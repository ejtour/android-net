...
public class SelectPurchaserListPresent implements ISelectPurchaserListContract.IPresent {
    private final int PAGE_SIZE = 20;
    private int pageNum = 1;
    private int pageTempNum = 1;
    private ISelectPurchaserListContract.IView mView;

    public static SelectPurchaserListPresent newInstance() {
        return new SelectPurchaserListPresent();
    }

    @Override
    public void register(ISelectPurchaserListContract.IView view) {
        mView = view;
    }
