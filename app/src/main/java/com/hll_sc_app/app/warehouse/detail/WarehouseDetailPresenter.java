 ...
 * @date 2019/8/5
 */
public class WarehouseDetailPresenter implements WarehouseDetailContract.ICooperationDetailPresenter {
    private WarehouseDetailContract.ICooperationDetailView mView;
    ...
    @Override
    public void register(WarehouseDetailContract.ICooperationDetailView view) {
