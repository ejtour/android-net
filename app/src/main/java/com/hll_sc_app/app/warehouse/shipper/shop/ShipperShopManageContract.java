 ...
 * @date 2019/8/7
 */
public interface ShipperShopManageContract {

    interface IShipperShopManageView extends ILoadView {
        /**
         * 代仓客户集团名称检索字段
         *
         * @return 搜索词
    ...
    interface IShipperShopManagePresenter extends IPresenter<IShipperShopManageView> {
        /**
         * 查询签约关系列表
         *
