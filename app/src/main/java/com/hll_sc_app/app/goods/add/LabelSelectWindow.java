 ...
 * @date 2019/6/21
 */
class LabelSelectWindow extends BaseShadowPopupWindow {
    @BindView(R.id.flowLayout)
    TagFlowLayout mFlowLayout;
    private FlowAdapter mAdapter;
    private SelectConfirmListener mListener;

    LabelSelectWindow(Activity context) {
        super(context);
        View view = View.inflate(context, R.layout.window_label_select, null);
