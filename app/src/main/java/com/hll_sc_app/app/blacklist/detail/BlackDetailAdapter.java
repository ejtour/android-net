...
import com.hll_sc_app.app.blacklist.product.SpecAdapter;
...
public class BlackDetailAdapter extends BaseQuickAdapter<OrientationDetailBean, BaseViewHolder> {
    private OnDelClickListener mListener;
    public BlackDetailAdapter() {
