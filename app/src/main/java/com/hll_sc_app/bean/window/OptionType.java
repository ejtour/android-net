...
@StringDef({OptionType.OPTION_EXPORT_ASSEMBLY, OptionType.OPTION_EXPORT_CHECK_CATEGORY, OptionType.OPTION_EXPORT_CHECK_DETAILS,
        ...
        OptionType.OPTION_COOPERATION_DETAIL_SHOP, OptionType.OPTION_EXPORT_DETAIL_INFO, OptionType.OPTION_EXPORT_INVOICE,
        OptionType.OPTION_REPORT_YES_DATE, OptionType.OPTION_REPORT_PRE_WEEK, OptionType.OPTION_REPORT_PRE_MONTH,
        OptionType.OPTION_REPORT_CUSTOMER_DEFINE, OptionType.OPTION_AGREEMENT_PRICE_LOG_EXPORT, OptionType.OPTION_WAREHOUSE_ADD,
        OptionType.OPTION_CURRENT_DATE, OptionType.OPTION_CURRENT_WEEK, OptionType.OPTION_CURRENT_MONTH,
        OptionType.OPTION_WAREHOUSE_CLIENT, OptionType.OPTION_STATISTIC_YEAR, OptionType.OPTION_EXPORT_BILL,
        OptionType.OPTION_EXPORT_BILL_DETAIL, OptionType.OPTION_BATCH_SETTLEMENT, OptionType.OPTION_REPORT_PRE_SEVEN_DATE,
        OptionType.OPTION_REPORT_PRE_THIRTY_DATE, OptionType.OPTION_REPORT_PRE_NINETY_DATE, OptionType.OPTION_NOT_DEPOSIT,
        OptionType.OPTION_EXPORT_PRICE_MANAGE_LOG, OptionType.OPTION_CHECK_PRICE_MANAGE_CHANGE_LOG, OptionType.OPTION_EXPORT_SUMMARY_TABLE,
        OptionType.OPTION_RECORD_PURCHASE_LOGISTICS, OptionType.OPTION_RECORD_PURCHASE_AMOUNT, OptionType.OPTION_PRE_SEVEN_LOSS,
        OptionType.OPTION_PRE_THIRTY_LOSS, OptionType.OPTION_EXPORT_DETAILS_TABLE, OptionType.OPTION_SET_MAN_HOUR_COST,
        OptionType.OPTION_PURCHASER_ORDER_CREATE_DATE, OptionType.OPTION_PURCHASER_ORDER_ARRIVAL_DATE, OptionType.OPTION_RECORD_PRODUCE_DATA,
        OptionType.OPTION_STOCK_LOG_EXPORT, OptionType.OPTION_COMPLAIN_ADD, OptionType.OPTION_COMPLAIN_EXPORT, OptionType.OPTION_ORDER_SHOP,
        OptionType.OPTION_PHONE_LINK, OptionType.OPTION_STATISTIC_DATE, OptionType.OPTION_STATISTIC_WEEK, OptionType.OPTION_NOT_ORDER_SHOP,
        OptionType.OPTION_STATISTIC_YEAR, OptionType.OPTION_STATISTIC_MONTH, OptionType.OPTION_COOPER_PURCHASER,
        OptionType.OPTION_STOP_COOPER_PURCHASER, OptionType.OPTION_WAREHOUSE_COMPANY, OptionType.OPTION_STOP_WAREHOUSE_COMPANY,
        OptionType.OPTION_WEEK, OptionType.OPTION_MONTH, OptionType.OPTION_REPORT_EXPORT_CUSTOMER_RECEIVE_LIST,
