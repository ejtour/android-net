...
public class ShopMarker extends MarkerView {
    ...
    public ShopMarker(Context context, Chart chart) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        LineDataSet item1 = (LineDataSet) data.getDataSetByIndex(0);
        LineDataSet item2 = (LineDataSet) data.getDataSetByIndex(1);
        LineDataSet item3 = (LineDataSet) data.getDataSetByIndex(2);
        mItem1.setText(String.format("门店总数：%s", CommonUtils.formatNumber(item1.getEntryForIndex((int) e.getX()).getY())));
        mItem2.setText(String.format("活跃门店数：%s", CommonUtils.formatNumber(item2.getEntryForIndex((int) e.getX()).getY())));
        mItem3.setText(String.format("新增门店数：%s", CommonUtils.formatNumber(item3.getEntryForIndex((int) e.getX()).getY())));
